...
public class SessionDataSource extends MPOSDatabase{
	 ...
	 */
	public List<com.synature.mpos.datasource.model.Session> listSession(String sessDate){
	 ...
	 * @return com.synature.mpos.database.model.Session
	 */
	public com.synature.mpos.datasource.model.Session getSession(int sId){
		com.synature.mpos.datasource.model.Session s =
				new com.synature.mpos.datasource.model.Session();
	...
	private com.synature.mpos.datasource.model.Session toSession(Cursor cursor){
		com.synature.mpos.datasource.model.Session s
			= new com.synature.mpos.datasource.model.Session();
		s.setSessionId(cursor.getInt(cursor.getColumnIndex(SessionTable.COLUMN_SESS_ID)));
		s.setSessionDate(cursor.getString(cursor.getColumnIndex(SessionTable.COLUMN_SESS_DATE)));
