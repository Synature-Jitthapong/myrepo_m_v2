 ...
 * 
 */
public class OrderTransDataSource extends MPOSDatabase {
	...
	public OrderTransDataSource(Context context) {
		super(context);
	}
	...
	public int countOrderStatusNotSuccess(String saleDate){
		...
		Cursor cursor = getReadableDatabase().rawQuery(
				...
				new String[]{
					...
					String.valueOf(OrderTransDataSource.TRANS_STATUS_HOLD),
					saleDate
				});
